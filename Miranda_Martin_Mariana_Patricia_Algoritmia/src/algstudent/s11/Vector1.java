...
package algstudent.s1 should be in the directory algstudent/s1.
*/
...
public class Vector1 {
	...
	public static void main(String arg []){
	  ...
	  System.out.println("Number of matches with a quadratic algorithm = " + matches1);
	  int matches2 = matches2(v, w);
	  System.out.println("Number of matches with a linear algorithm = " + matches2);
	} 
